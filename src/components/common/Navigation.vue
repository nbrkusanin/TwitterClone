    ...
    <nav class="flex items-center justify-between flex-wrap bg-green-500 p-6">
      ...
      <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto justify-end">
        ...
        <div class="flex items-center justify-between ml-5">
          <button class="bg-white border hover:bg-green-500 hover:text-white hover:border-white text-green-500 font-bold py-2 px-4 rounded" type="button">
            Register
          </button>
          <button class="bg-white border hover:bg-green-500 hover:text-white hover:border-white text-green-500 font-bold py-2 px-4 rounded ml-2" type="button">
            Login
          </button>
        </div>
      </div>
